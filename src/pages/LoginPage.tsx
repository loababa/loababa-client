    ...
    <section className="px-[20px]">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col gap-[8px] w-full mt-[20px]">
          <Link
            to={`https://kauth.kakao.com/oauth/authorize?client_id=${import.meta.env.VITE_KAKAO_CLIENT_ID}&redirect_uri=http://localhost:5173/lossam/signup&response_type=code&state=${lossamKey ?? ""}`}
            rel="noreferrer">
            <Button
              className={clsx(
